...
Note Livin_Prayer[THUNDER_CHART_SIZE] = {
        {.lane = 1, .spawnTime = 7.5636f},  // s
        {.lane = 2, .spawnTime = 8.0226f},  // j
        {.lane = 1, .spawnTime = 8.5046f},  // s
        {.lane = 0, .spawnTime = 8.9436f},  // a
        {.lane = 1, .spawnTime = 9.4146f},  // s
        {.lane = 2, .spawnTime = 9.9106f},  // j
        {.lane = 1, .spawnTime = 10.3826f}, // s
        {.lane = 0, .spawnTime = 10.8776f}, // a
        {.lane = 1, .spawnTime = 11.3946f}, // s
        {.lane = 2, .spawnTime = 11.8846f}, // j
        {.lane = 1, .spawnTime = 12.3856f}, // s
        {.lane = 0, .spawnTime = 12.8606f}, // a
        {.lane = 1, .spawnTime = 13.3166f}, // s
        {.lane = 2, .spawnTime = 13.8656f}, // j
        {.lane = 1, .spawnTime = 14.3446f}, // s
        {.lane = 0, .spawnTime = 14.7976f}, // a
        {.lane = 1, .spawnTime = 15.3006f}, // s
        {.lane = 2, .spawnTime = 15.7936f}, // j
        {.lane = 1, .spawnTime = 16.3036f}, // s
        {.lane = 0, .spawnTime = 16.7636f}, // a
        {.lane = 1, .spawnTime = 17.2956f}, // s
        {.lane = 2, .spawnTime = 17.7956f}, // j
        {.lane = 1, .spawnTime = 18.2846f}, // s
        {.lane = 0, .spawnTime = 18.7376f}, // a
        {.lane = 1, .spawnTime = 19.2486f}, // s
        {.lane = 2, .spawnTime = 19.7466f}, // j
        {.lane = 1, .spawnTime = 20.2746f}, // s
        {.lane = 0, .spawnTime = 20.7306f}, // a
        {.lane = 1, .spawnTime = 21.2606f}, // s
        {.lane = 2, .spawnTime = 21.7896f}, // j
        {.lane = 1, .spawnTime = 22.2976f}, // s
        {.lane = 0, .spawnTime = 22.6976f}, // a
        {.lane = 1, .spawnTime = 23.1866f}, // s
        {.lane = 2, .spawnTime = 23.6896f}, // j
        {.lane = 1, .spawnTime = 24.2286f}, // s
        {.lane = 0, .spawnTime = 24.6996f}, // a
        {.lane = 1, .spawnTime = 25.1816f}, // s
        {.lane = 2, .spawnTime = 25.6706f}, // j
        {.lane = 1, .spawnTime = 26.1946f}, // s
        {.lane = 0, .spawnTime = 26.6086f}, // a
        {.lane = 1, .spawnTime = 27.1186f}, // s
        {.lane = 2, .spawnTime = 27.6366f}, // j
        {.lane = 1, .spawnTime = 28.0896f}, // s
        {.lane = 0, .spawnTime = 28.5716f}, // a
        {.lane = 1, .spawnTime = 29.1116f}, // s
        {.lane = 2, .spawnTime = 29.6026f}, // j
        {.lane = 1, .spawnTime = 30.0756f}, // s
        {.lane = 0, .spawnTime = 30.5366f}, // a
        {.lane = 1, .spawnTime = 30.9996f}, // s
        {.lane = 2, .spawnTime = 31.5396f}, // j
        {.lane = 1, .spawnTime = 32.0576f}, // s
        {.lane = 0, .spawnTime = 32.5246f}, // a
        {.lane = 1, .spawnTime = 33.0296f}, // s
        {.lane = 2, .spawnTime = 33.5526f}, // j
        {.lane = 1, .spawnTime = 33.9856f}, // s
        {.lane = 0, .spawnTime = 34.4876f}, // a
        {.lane = 1, .spawnTime = 35.0136f}, // s
        {.lane = 2, .spawnTime = 35.4826f}, // j
        {.lane = 1, .spawnTime = 35.9606f}, // s
        {.lane = 0, .spawnTime = 36.4386f}, // a
        {.lane = 1, .spawnTime = 36.9446f}, // s
        {.lane = 2, .spawnTime = 37.4366f}, // j
        {.lane = 1, .spawnTime = 37.9366f}, // s
        {.lane = 0, .spawnTime = 38.3996f}, // a
        {.lane = 1, .spawnTime = 38.9306f}, // s

        // Special segment (double notes) - adjusted times
        {.lane = 2, .spawnTime = 39.4376f},  // j
        {.lane = 1, .spawnTime = 39.4376f},  // s
        {.lane = 2, .spawnTime = 41.4136f},  // j
        {.lane = 3, .spawnTime = 41.4136f},  // k
        {.lane = 2, .spawnTime = 43.4476f},  // j

        // Return to standard pattern - adjusted times
        {.lane = 1, .spawnTime = 43.8916f},  // s
        {.lane = 0, .spawnTime = 44.3196f},  // a
        {.lane = 1, .spawnTime = 44.8496f},  // s
        {.lane = 2, .spawnTime = 45.2986f},  // j
        {.lane = 1, .spawnTime = 45.8026f},  // s
        {.lane = 0, .spawnTime = 46.2836f},  // a
        {.lane = 1, .spawnTime = 46.8016f},  // s
        {.lane = 2, .spawnTime = 47.3086f},  // j
        {.lane = 1, .spawnTime = 47.7976f},  // s
        {.lane = 0, .spawnTime = 48.2566f},  // a
        {.lane = 1, .spawnTime = 48.7876f},  // s
        {.lane = 2, .spawnTime = 49.2666f},  // j
        {.lane = 1, .spawnTime = 49.7266f},  // s
        {.lane = 0, .spawnTime = 50.2026f},  // a
        {.lane = 1, .spawnTime = 50.7596f},  // s
        {.lane = 2, .spawnTime = 51.2246f},  // j
        {.lane = 1, .spawnTime = 51.6966f},  // s
        {.lane = 0, .spawnTime = 52.1766f},  // a
        {.lane = 1, .spawnTime = 52.7216f},  // s
        {.lane = 2, .spawnTime = 53.2046f},  // j
        {.lane = 1, .spawnTime = 53.7166f},  // s
        {.lane = 0, .spawnTime = 54.1856f},  // a
        {.lane = 1, .spawnTime = 54.6946f},  // s

        // Special segment (simultaneous notes) - adjusted times
        {.lane = 1, .spawnTime = 55.1936f},  // s
        {.lane = 2, .spawnTime = 55.1936f},  // j
        {.lane = 2, .spawnTime = 57.2476f},  // j
        {.lane = 3, .spawnTime = 57.2476f},  // k
        {.lane = 2, .spawnTime = 59.1836f},  // j

        // Return to standard pattern - adjusted times
        {.lane = 1, .spawnTime = 59.6666f},  // s
        {.lane = 0, .spawnTime = 60.1606f},  // a
        {.lane = 1, .spawnTime = 60.6426f},  // s
        {.lane = 2, .spawnTime = 61.1166f},  // j
        {.lane = 1, .spawnTime = 61.5786f},  // s
        {.lane = 0, .spawnTime = 62.0896f},  // a
        {.lane = 1, .spawnTime = 62.6056f},  // s
        {.lane = 0, .spawnTime = 63.0326f},  // a

        // Special segment (rapid notes) - adjusted times
        {.lane = 1, .spawnTime = 63.0326f},  // s
        {.lane = 1, .spawnTime = 63.8506f},  // s
        {.lane = 2, .spawnTime = 63.8506f},  // j
        {.lane = 2, .spawnTime = 65.0586f},  // j
        {.lane = 1, .spawnTime = 65.0586f},  // s
        {.lane = 1, .spawnTime = 65.5406f},  // s
        {.lane = 2, .spawnTime = 65.5406f},  // j
        {.lane = 2, .spawnTime = 66.0036f},  // j
        {.lane = 3, .spawnTime = 66.0036f},  // k

        // Mixed pattern - adjusted times
        {.lane = 0, .spawnTime = 66.9736f},  // a
        {.lane = 1, .spawnTime = 66.9736f},  // s
        {.lane = 1, .spawnTime = 67.7476f},  // s
        {.lane = 2, .spawnTime = 67.7476f},  // j
        {.lane = 1, .spawnTime = 68.9986f},  // s
        {.lane = 2, .spawnTime = 68.9986f},  // j
        {.lane = 2, .spawnTime = 69.4936f},  // j
        {.lane = 1, .spawnTime = 69.4936f},  // s
        {.lane = 2, .spawnTime = 69.9726f},  // j
        {.lane = 3, .spawnTime = 69.9726f},  // k
        {.lane = 1, .spawnTime = 70.9326f},  // s
        {.lane = 0, .spawnTime = 70.9326f},  // a
        {.lane = 2, .spawnTime = 71.6936f},  // j
        {.lane = 1, .spawnTime = 71.6936f},  // s
        {.lane = 1, .spawnTime = 72.9016f},  // s
        {.lane = 2, .spawnTime = 72.9016f},  // j
        {.lane = 1, .spawnTime = 73.3436f},  // s
        {.lane = 2, .spawnTime = 73.3436f},  // j
        {.lane = 2, .spawnTime = 73.8486f},  // j
        {.lane = 3, .spawnTime = 73.8486f},  // k
        {.lane = 2, .spawnTime = 74.3526f},  // j
        {.lane = 1, .spawnTime = 74.8136f},  // s
        {.lane = 2, .spawnTime = 74.8136f},  // j
        {.lane = 2, .spawnTime = 76.8326f},  // j
        {.lane = 3, .spawnTime = 76.8326f},  // k
        {.lane = 3, .spawnTime = 77.4596f},  // k
        {.lane = 2, .spawnTime = 77.4596f},  // j
        {.lane = 3, .spawnTime = 77.7066f},  // k
        {.lane = 2, .spawnTime = 77.7066f},  // j
        {.lane = 2, .spawnTime = 78.2606f},  // j
        {.lane = 1, .spawnTime = 78.7286f},  // s
        {.lane = 0, .spawnTime = 78.7286f},  // a
        {.lane = 2, .spawnTime = 79.4536f},  // j
        {.lane = 1, .spawnTime = 79.4536f},  // s
        {.lane = 3, .spawnTime = 80.7686f},  // k
        {.lane = 2, .spawnTime = 80.7686f},  // j
        {.lane = 0, .spawnTime = 82.6576f},  // a
        {.lane = 2, .spawnTime = 82.6576f},  // j
        {.lane = 2, .spawnTime = 83.3456f},  // j
        {.lane = 1, .spawnTime = 83.3456f},  // s
        {.lane = 2, .spawnTime = 84.6286f},  // j
        {.lane = 3, .spawnTime = 84.6286f},  // k
        {.lane = 0, .spawnTime = 86.5406f},  // a
        {.lane = 1, .spawnTime = 86.5406f},  // s
        {.lane = 2, .spawnTime = 87.2386f},  // j
        {.lane = 1, .spawnTime = 87.2386f},  // s
        {.lane = 2, .spawnTime = 88.4736f},  // j
        {.lane = 3, .spawnTime = 88.4736f},  // k
        {.lane = 2, .spawnTime = 90.4076f},  // j
        {.lane = 0, .spawnTime = 90.4076f},  // a
        {.lane = 1, .spawnTime = 91.1366f},  // s
        {.lane = 2, .spawnTime = 91.1366f},  // j
        {.lane = 3, .spawnTime = 92.3486f},  // k
        {.lane = 2, .spawnTime = 92.3486f},  // j
        {.lane = 2, .spawnTime = 94.2566f},  // j
        {.lane = -1}
};